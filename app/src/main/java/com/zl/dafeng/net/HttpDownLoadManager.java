...
public class HttpDownLoadManager {
    ...
    public HttpDownLoadManager(DownLoadCallBack callBack) {
        this.callBack = callBack;
        handler = new Handler(Looper.getMainLooper());
    }

    private static HttpDownLoadManager sInstance;

    /**
     *DownLoadManager getInstance
     */
    public static synchronized HttpDownLoadManager getInstance(DownLoadCallBack callBack) {
        if (sInstance == null) {
            sInstance = new HttpDownLoadManager(callBack);
        }
        return sInstance;
    }
