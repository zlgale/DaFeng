...
import com.zl.dafeng.net.util.Utils;
...
public final class Novate {
    ...
    public void download(String url, DownLoadCallBack callBack) {
        ...
        if (HttpDownLoadManager.isDownLoading) {
            downObservable.unsubscribeOn(Schedulers.io());
            HttpDownLoadManager.isDownLoading = false;
            HttpDownLoadManager.isCancel = true;
            return;
        }
        HttpDownLoadManager.isDownLoading = true;
    ...
    public static final class Builder {
        ...
        private HttpCookieManger cookieManager;
         ...
         * <p/>
         * <p>If unset, {@linkplain HttpCookieManger#NO_COOKIES no cookies} will be accepted nor provided.
         */
        public Builder cookieManager(HttpCookieManger cookie) {
        ...
        public Novate build() {
           ...
           ;
            ...
            if (cookieManager == null) {
                cookieManager = new HttpCookieManger(context);
            }
            okhttpBuilder.cookieJar(new HttpCookieManger(context));
