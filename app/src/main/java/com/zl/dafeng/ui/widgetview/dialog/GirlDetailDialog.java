...
public class GirlDetailDialog extends BottomBaseDialog<GirlDetailDialog> {
    ...
    public GirlDetailDialog(Context context, View animateView) {
        super(context, animateView);
    }

    public GirlDetailDialog(Context context) {
        super(context);
    }

    @Override
    public View onCreateView() {
        View inflate = View.inflate(mContext, R.layout.dialog_girldetail, null);
