...
import com.zl.dafeng.net.BaseApiService;
import com.zl.dafeng.net.BaseSubscriber;
import com.zl.dafeng.net.DownLoadCallBack;
import com.zl.dafeng.net.Novate;
import com.zl.dafeng.net.NovateResponse;
 ...
 * }
 */
public class TestHttpRequestActivity extends AppCompatActivity {
    ...
    private void performTest() {
        ...
        novate.test("https://apis.baidu.com/apistore/weatherservice/cityname?cityname=上海", null,
                new BaseSubscriber<ResponseBody>(TestHttpRequestActivity.this) {
            @Override
            public void onError(Throwable e) {
                super.onError(e);
                Log.e("OkHttp", e.getMessage());
                Toast.makeText(TestHttpRequestActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onNext(ResponseBody responseBody) {
                try {
                    Toast.makeText(TestHttpRequestActivity.this, new String(responseBody.bytes()), Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
    ...
    private void perform() {
        ...
        novate.get("v2/movie/top250", parameters, new BaseSubscriber<ResponseBody>(TestHttpRequestActivity.this) {
            @Override
            public void onNext(ResponseBody responseBody) {
                try {
                    ...
                    Toast.makeText(TestHttpRequestActivity.this, response.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void performGet() {
        ...
        novate.executeGet("service/getIpInfo.php", parameters, new Novate.ResponseCallBack<NovateResponse<ResultModel>>() {
            ...
            public void onSuccee(NovateResponse<ResultModel> response) {
                Toast.makeText(TestHttpRequestActivity.this, response.getData().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void performPost() {
         ...
         * 参考 performGet()中的方式
         */
        novate.post("service/getIpInfo.php", parameters, new BaseSubscriber<ResponseBody>(TestHttpRequestActivity.this) {
            @Override
            public void onError(Throwable e) {
    ...
    private void perform_Api() {
        ...
        novate.call(myAPI.getSougu(parameters),
                new BaseSubscriber<SouguBean>(TestHttpRequestActivity.this) {
                    ...
                    public void onNext(SouguBean souguBean) {
                        ...
                        Toast.makeText(TestHttpRequestActivity.this, souguBean.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void performUpLoad() {
        ...
        novate.upload(url, requestFile, new BaseSubscriber<ResponseBody>(TestHttpRequestActivity.this) {
            @Override
            public void onNext(ResponseBody responseBody) {
    ...
    private void performDown() {
        ...
        novate.download(downUrl, new DownLoadCallBack() {
            ...
            public void onStart() {
                super.onStart();
                Toast.makeText(TestHttpRequestActivity.this, "download is start", Toast.LENGTH_SHORT).show();
            ...
            public void onSucess(String path, String name, long fileSize) {
                Toast.makeText(TestHttpRequestActivity.this, "download  onSucess", Toast.LENGTH_SHORT).show();
                btn_download.setText("DownLoad start");
            }
        });
    }
