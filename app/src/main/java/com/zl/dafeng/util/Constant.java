...
public class Constant {
     ...
     * 预览图片的临时路径
     */
    public static String IMAGE_TEMP_PAHT = "/TSPROJECT/temp_image/";

    /**
     * 图片裁剪宽限制
     */
    public static int REVIEW_FIEL_WIDRH = 120;
    /**
     * 图片裁剪高限制
     */
    public static int REVIEW_FIEL_HEIGHT = 120;
...
//    public static final String COMMONURL = "http://api.miaodj.cn/index.php/App/";
     ...
     */
//    // 图片前缀
//    public static final String  IMGURL= "http://release.miaodj.cn";
//    // 通用地址
//    public static final String COMMONURL = "http://release.miaodj.cn/index.php/App/";
    /**
     * 外网测试接口
     */
    // 图片前缀
    ...
    // 实时定位
    public static final String get_current_location = "http://test3.emplus.cn/index.php?m=Vans&c=order&a=get_current_location";
    // 竞价申请
    public static final String apply_fictitious_order = "http://test3.emplus.cn/index.php?m=Vans&c=order&a=apply_fictitious_order";
}
